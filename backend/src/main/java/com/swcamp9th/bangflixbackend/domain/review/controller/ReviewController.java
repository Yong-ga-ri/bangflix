...
public class ReviewController {
    ...
    public ResponseEntity<Response<Object>> createReview(
        ...
        return ResponseEntity.ok(new Response<>(200, "리뷰 작성 성공", null));
    }
    ...
    public ResponseEntity<Response<Object>> deleteReview(
        ...
        return ResponseEntity.ok(new Response<>(200, "리뷰 삭제 성공", null));
    }
    ...
    public ResponseEntity<Response<List<ReviewDTO>>> findReviewList(
        ...
        return ResponseEntity.ok(new Response<>(200, "리뷰 조회 성공", reviews));
    }
    ...
    public ResponseEntity<Response<StatisticsReviewDTO>> findReviewStatistics(
        @PathVariable("themeCode") Integer themeCode
    ) {
        StatisticsReviewDTO reviewStatistics = reviewService.findReviewStatistics(themeCode);
        return ResponseEntity.ok(new Response<>(200, "리뷰 통계 조회 성공", reviewStatistics));
    }
    ...
    public ResponseEntity<Response<Object>> likeReview(
            @RequestBody ReviewCodeDTO reviewCodeDTO,
            @RequestAttribute(SERVLET_REQUEST_ATTRIBUTE_KEY) String loginId
    ) {
        int memberCode = userService.findMemberCodeByLoginId(loginId);
        reviewService.likeReview(reviewCodeDTO, memberCode);
        return ResponseEntity.ok(new Response<>(200, "리뷰 좋아요 성공", null));
    }
    ...
    public ResponseEntity<Response<Object>> deleteLikeReview(
            @RequestBody ReviewCodeDTO reviewCodeDTO,
            @RequestAttribute(SERVLET_REQUEST_ATTRIBUTE_KEY) String loginId
    ) {
        int memberCode = userService.findMemberCodeByLoginId(loginId);
        reviewService.deleteLikeReview(reviewCodeDTO, memberCode);
        return ResponseEntity.ok(new Response<>(200, "리뷰 좋아요 취소 성공", null));
    }
    ...
    public ResponseEntity<Response<ReviewReportDTO>> findReviewReport(
        @RequestAttribute(SERVLET_REQUEST_ATTRIBUTE_KEY) String loginId
    ) {
        int memberCode = userService.findMemberCodeByLoginId(loginId);

        ReviewReportDTO reviewReportDTO = reviewService.findReviewReport(memberCode);
        return ResponseEntity.ok(new Response<>(200, "유저 리뷰 report 조회 성공", reviewReportDTO));
    }
    ...
    public ResponseEntity<Response<List<ReviewDTO>>> findReviewByMember(
        @RequestAttribute(SERVLET_REQUEST_ATTRIBUTE_KEY) String loginId,
        @PageableDefault(size = 10, page = 0) Pageable pageable
    ) {
        int memberCode = userService.findMemberCodeByLoginId(loginId);
        ...
        return ResponseEntity.ok(new Response<>(200, "유저가 작성한 리뷰 조회 성공", reviews));
    }
}

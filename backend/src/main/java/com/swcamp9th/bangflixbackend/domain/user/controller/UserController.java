...
public class UserController {
    ...
    public ResponseEntity<SuccessResponse<Object>> logout(
        ...
        return ResponseEntity.ok(new SuccessResponse<>(200, "로그아웃 성공", null));
    }
    ...
    public ResponseEntity<SuccessResponse<UserInfoResponseDto>> findUserInfoById(
        ...
        return ResponseEntity.ok(new SuccessResponse<>(200, "회원 정보 조회 성공", userService.findUserInfoById(userId)));
    }
    ...
    public ResponseEntity<SuccessResponse<Object>> updateUserInfo(
        ...
        return ResponseEntity.ok(new SuccessResponse<>(200, "리뷰 수정 성공", null));
    }
    ...
    public ResponseEntity<SuccessResponse<MyPageResponseDto>> findMyPageInfoById(@RequestAttribute(SERVLET_REQUEST_ATTRIBUTE_KEY) String userId) {
        return ResponseEntity.ok(new SuccessResponse<>(200, "회원 정보 조회 성공", userService.findMyPageInfoById(userId)));
    }
}
...
public class UserController {
    ...
    public ResponseEntity<ResponseMessage<Object>> logout(
    ...
    public ResponseEntity<ResponseMessage<UserInfoResponseDto>> findUserInfoById(
        ...
        return ResponseEntity.ok(new ResponseMessage<>(200, "회원 정보 조회 성공", userService.findUserInfoById(userId)));
    }
    ...
    public ResponseEntity<ResponseMessage<Object>> updateUserInfo(
